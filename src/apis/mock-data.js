  ...
  board: {
    ...
    columns: [
        ...
        cards: [
          {
            ...
            cover: 'https://images.unsplash.com/photo-1729280277171-71a6acd762e6?q=80&w=2068&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      ...
      },
      {
        ...
        //Cách sử lý logic thư viện dnd-kit khi column là rỗng
        ...
        //Kỹ hơn nữa về cách tạo chuẩn ở bước nào thì sẽ học ở phần tích hợp API Back-end vào dự án. Bởi vì đây là file
        //mock-data.js
